    ...
    return (
        <div>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 m-10'>
                <div class="card  max-w-[320px] mx-auto bg-base-100 shadow-xl">
                    <figure class="px-10 pt-10">
                        <div class="avatar">
                            <div class="w-32 mask mask-hexagon bg-primary">
                    ...
                    <div class="card-body items-center text-center">
                        <h2 class="card-title text-2xl">Fast</h2>
                ...
                <div class="card  max-w-[320px] mx-auto bg-base-100 shadow-xl">
                    ...
                    <div class="card-body items-center text-center">
                        <h2 class="card-title text-2xl">Intuitive</h2>
                ...
                <div class="card  max-w-[320px] mx-auto bg-base-100 shadow-xl">
                    ...
                    <div class="card-body items-center text-center">
                        <h2 class="card-title text-2xl">Responsive</h2>
                ...
                <div class="card  max-w-[320px] mx-auto bg-base-100 shadow-xl">
                    ...
                    <div class="card-body items-center text-center">
                        <h2 class="card-title text-2xl">Dynamic</h2>
