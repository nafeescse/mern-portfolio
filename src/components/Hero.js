            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 justify-items-center py-auto'>
                ...
                <div className=' flex flex-col items-center lg:items-start my-auto'>
                    ...
                    <div className='flex justify-center items-center my-5'>
                        <button className="hover:bg-white hover:text-primary btn btn-primary mr-10 btn-sm rounded- text-white"><a target='_blank' href="https://drive.google.com/file/d/1S2azPzzz7atzwOPcdG8HMh-m-COM7Zwt/view" rel='noreferrer'>Resume</a></button>
                        <div>
